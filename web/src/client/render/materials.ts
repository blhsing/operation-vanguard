 ...
 * `enemy` pushes it green or red so friend-or-foe survives low light and
 * peripheral vision. Silhouette accents are applied by
...
export function teamMaterial(team: Team, enemy: boolean): THREE.Material {
  ...
  return cached(key, () => {
    ...
    const tint = enemy ? 0x2fae4b : 0xb02f28;
